var store = [{
        ...
        "title": "6 Week",
        "excerpt":"Web Web의 정의를 물어보면 뭐라고 답하기 애매하다. 간단하게 한번 짚고 넘어가자 World Wide Web 인터넷에 연결된 사용자들이 서로의 정보를 공유할 수 있는 공간 텍스트, 그림, 소리, 영상 등의 멀티미디어 정보를 하이퍼텍스트 방식으로 연결 하이퍼텍스트 : 문서 내부에 또다른 문서가 연결되는 참조를 넣음 웹페이지들은 각각 연결되어 있는데 이로 인해 거미줄처럼 얽혀있는...","categories": ["TIL"],
        "tags": ["Tomcat","Filter","Web","Session","OSI 7계층","TCP / UDP","Bulk 처리","SSR","CSR"],
